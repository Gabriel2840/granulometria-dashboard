...
with tab_reg:
    ...
    st.caption("Edite a tabela: informe até 15 peneiras com suas respectivas massas. O TOTAL é calculado automaticamente.")

    # Criar DataFrame editável com 15 linhas
    ...
    edited_df = st.data_editor(
        ...
        hide_index=True,
        column_config={
            "Abertura (mm)": st.column_config.TextColumn(width="medium"),
    ...
    # Calcular total
    total_massa = sum(float(v) if v and str(v).replace(".", "").replace("-", "").isdigit() else 0.0
