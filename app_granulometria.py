...
def criar_mandala_svg():
    ...
    <div class="mandala-spinner">
        <svg viewBox="0 0 100 100" width="100" height="100" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <style>
                    .rotate-layer { animation: spin 20s linear infinite; }
                    @keyframes spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
                </style>
            </defs>
            <g class="rotate-layer">
                <circle cx="50" cy="50" r="48" fill="none" stroke="#1a3a52" stroke-width="2"/>
                <circle cx="50" cy="50" r="40" fill="none" stroke="#ff6b35" stroke-width="1.5"/>
                <circle cx="50" cy="50" r="30" fill="none" stroke="#1a3a52" stroke-width="1"/>
                <circle cx="50" cy="50" r="20" fill="none" stroke="#ff6b35" stroke-width="1"/>
                <circle cx="50" cy="50" r="10" fill="#ff6b35"/>
                <line x1="50" y1="5" x2="50" y2="95" stroke="#1a3a52" stroke-width="0.8" opacity="0.6"/>
                <line x1="5" y1="50" x2="95" y2="50" stroke="#1a3a52" stroke-width="0.8" opacity="0.6"/>
            </g>
        </svg>
    </div>
    """
