...
# Debug
if ensaios:
    st.sidebar.write(f"✅ {len(ensaios)} ensaio(s) carregado(s)")
    st.sidebar.write(f"Primeiro ensaio: {ensaios[0].get('amostra', 'N/A')}")
    st.sidebar.write(f"Massas: {ensaios[0].get('massas', {})}")
